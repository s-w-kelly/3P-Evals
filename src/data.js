...
export const analysisContent = {
  analysisInsights: [
     {
      id: "analysis-1",
      title: "A third-party evaluator ecosystem has emerged",
      content: `
      <p>In <a href="https://metr.org/blog/2023-03-18-update-on-recent-evals/">2023</a> (the starting point for this dashboard’s analysis), there was essentially one third-party frontier model evaluator: METR (then ARC). Now, there are at least 13 private organizations, three government entities, and significant involvement by domain experts, individual red teamers, and uplift trial participants. These evaluators are filling gaps in key risk areas like CBRN risks, cybersecurity, scheming, and model welfare.</p>  
      <p><a href="https://arxiv.org/abs/2304.04914">Several</a> <a href="https://arxiv.org/abs/2504.11501">policy</a> <a href="https://www.whitehouse.gov/wp-content/uploads/2025/07/Americas-AI-Action-Plan.pdf#page=10">proposals</a> have envisioned an ecosystem or market for third-party AI model evaluators. That vision seems to slowly be emerging.</p>
      `,
    },
    {
      id: "analysis-2",
      ...
      content: `
        <p>Third-party evals are increasing in scope/intensity as the capabilities and potential risks associated with the models increase.</p>
        <p>In particular, Anthropic and OpenAI have substantially expanded third-party engagement and ramped up CBRN, cybersecurity, and autonomy evals.</p>
        <p>Labs are also giving evaluators greater access to the models than ever before. The GPT-5 System Card <a href="https://cdn.openai.com/gpt-5-system-card.pdf#page=53">described</a> how the UK AISI was “provided access to prototype versions of our safeguards and information sources that are not publicly available – such as our monitor system design, biological content policy, and chains of thoughts of our monitor models,” which “allowed them to perform more rigorous stress testing and identify potential vulnerabilities more easily than malicious users.” With this enhanced access, the AISI “identified multiple model-level jailbreaks” that it may not have otherwise.</p>
        <p>Beth Barnes, founder and CEO of METR, also <a href="https://thezvi.substack.com/p/gpt-5s-are-alive-basic-facts-benchmarks?open=false#%C2%A7that-one-graph-from-metr">reported</a> that “due to increased access [to GPT-5] (plus improved evals science) we were able to do a more meaningful evaluation than with past models, and we think we have substantial evidence that this model does not pose a catastrophic risk via autonomy / loss of control threat models.” She added that OpenAI “should get a bunch of credit for sharing sensitive information with us - especially [Chain of Thought (‘CoT’)] access, and providing answers to all of the key questions we needed about model development, affordances, and behaviors.” Apollo received CoT access as well.</p>
      `,
    },
    {
      id: "analysis-3",
      title: "Third-party evaluators frequently uncover issues",
      content: `
        <p>In many cases, third-party evals are doing (at least part of) what they’re supposed to do: finding issues the developer may not have been found themselves.</p>
        <p>The system cards for <a href="https://cdn.openai.com/gpt-5-system-card.pdf#page=52">GPT-5</a>, <a href="https://www-cdn.anthropic.com/6be99a52cb68eb70eb9572b4cafad13df32ed995.pdf#page=30">Claude 4</a>, <a href="https://cdn.openai.com/pdf/419b6906-9da6-406c-a19d-1bb078ac7637/oai_gpt-oss_model_card.pdf#page=19">gpt-oss</a>, <a href="https://cdn.openai.com/pdf/839e66fc-602c-48bf-81d3-b21eacc3459d/chatgpt_agent_system_card.pdf#page=40">ChatGPT agent</a>, and <a href="cdn.openai.com/papers/gpt-4-system-card.pdf#page=5">GPT-4</a> all note examples of external evaluators finding issues that were corrected before deployment. As noted above, the UK AISI/GPT-5 case study emphasizes how increased access can directly lead to more discoveries by the evaluators.</p>      
      `,
    },
    {
      id: "analysis-4",
      title: "Third-party evals aren’t providing meaningful oversight (per the evaluators themselves)",
      content: `
        <p>Third-party evals aren’t currently providing meaningful oversight, as labs continue to impose significant constraints on evaluators, including NDAs, limited access, and little to no authority to alert outside parties or halt training/deployment if high-risk issues are uncovered.</p>
        <p>System cards often present third-party evals as authoritative and definitive, but the evaluators have made clear that this isn’t the case. As Barnes <a href="https://80000hours.org/podcast/episodes/beth-barnes-ai-safety-evals/#do-we-need-external-auditors-doing-ai-safety-tests-not-just-the-companies-themselves-013510">put it</a>: “[L]abs more want a ‘Can you promise that you will run an eval on all of our models when we want to, so that we can say we’ve run an eval on them?’ sort of thing.”</p>
        ...
        <p>METR’s <a href="https://evaluations.metr.org/gpt-5-report/">GPT-5</a> and <a href="https://evaluations.metr.org/gpt-5-1-codex-max-report/">GPT-5.1-Codex-Max</a> reports note that “OpenAI’s comms and legal team required review and approval of this post” and clarify again that “this evaluation shouldn’t be interpreted as robust formal oversight or accountability that the public can be relying on METR to provide.”</p>
        ...
        <p>Anthropic <a href="https://www-cdn.anthropic.com/6be99a52cb68eb70eb9572b4cafad13df32ed995.pdf#page=31">admitted</a> that it had noticed these issues as well and claimed they were subsequently fixed. But it <a href="https://newsletter.safe.ai/p/ai-safety-newsletter-56-google-releases?open=false#%C2%A7opus-demonstrates-the-fragility-of-voluntary-governance">doesn’t appear</a> Apollo had the opportunity to re-evaluate the model before it was deployed.</p>
        <p>In short, some high-quality testing is happening, but without independent authority or follow-up, it’s not true oversight.</p>
      `,
    },
    {
      ...
      content: `
        ...
        <p>xAI is even worse. xAI neglected to release a formal model card until Grok 4, in which it only vaguely noted third-party testing, seemingly only for cyber capabilities. As reported in <a href="https://www.transformernews.ai/p/sam-altman-ai-bubble#:~:text=xAI%20finally%20published%20a%20model%20card%20for%20Grok%204">Transformer</a>, the initial version of the model card said that the UK AISI evaluated the model and that its results “largely confirm our internal findings: an un-safeguarded version of Grok 4 poses a plausible risk of assisting a non-expert in the creation of a chemical or biological weapon.” Shortly after the system card was initially published, xAI updated the card and removed all mention of UK AISI’s evaluation and findings. xAI’s four model cards since Grok 4 have not mentioned third-party testing.</p>
      `,
    },
    {
      id: "analysis-6",
      title: "The determination of when third-party evals are performed should be improved",
      content: `
        <p>With no formal rules in place, labs decide when they want third-party evals to happen. This has created problems that point to a need to improve the determination of when third-party evals occur.</p>
        <p><strong>Problem 1: Benchmark-based thresholds miss real-world capability gains.</strong> Labs often skip evals for incremental model updates. This is reasonable in principle. But the labs themselves determine what counts as “incremental,” and sometimes that determination is questionable.</p>
        ...
        <p>In other words, maybe benchmarks won’t reliably tell us when a model has improved in real-world performance such that we need to re-evaluate it.</p>
        ...
        <p>Opus 4.1 shows us that we need to account for performance on real-world tasks when determining what evals to perform for a model and whether third parties should be involved. We certainly can’t assume that just because there’s “only an 0.1 increase” to the model number, the performance boost can’t be that high.</p>      
        <p><strong>Problem 2: Cherry-picking which models to evaluate creates gaps.</strong> There’s also a practice of evaluating some, but not all, models in a release. Usually this means evals are performed on just the largest/presumably most capable model and not the smaller/presumably less capable one(s). Once again, this seems reasonable in theory but can be problematic in practice since the labs are free to make this choice on their own.</p>
        <p>OpenAI’s GPT-5 <a href="https://cdn.openai.com/gpt-5-system-card.pdf#page=5">system card</a> “focuses primarily on gpt-5-thinking and gpt-5-main,” rather than the most powerful model, gpt-5-thinking-pro. OpenAI’s rationale was that, “[s]ince gpt-5-thinking-pro is gpt-5-thinking using a setting that makes use of parallel test time compute, we have determined that the results from our safety evaluations on gpt-5-thinking are strong proxies, and therefore we did not rerun these evaluations in the parallel test time compute setting.”</p>
        ...
        <p>So the architectural differences may be minor, but OpenAI itself seems to think this makes a notable performance difference. The evals therefore should have been performed on the Pro version. If you’re not going to test all of the models, one of them should be the most powerful model.</p>
        <p>But other results in the GPT-5 system card suggest that maybe the practice of only evaluating the largest model isn’t a good idea anyway. On one of the <a href="https://cdn.openai.com/gpt-5-system-card.pdf#page=32">“cyber range” evals</a>—which “measure a model’s ability to conduct fully end-to-end cyber operations in a realistic, emulated network”—gpt-5-thinking-mini substantially outperformed all other models.</p>
        <p>OpenAI <a href="https://cdn.openai.com/gpt-5-system-card.pdf#page=32">clarifies</a> that, “[w]hile gpt-5-thinking-mini’s results on the cyber range are technically impressive and an improvement over prior releases, the results do not meet the bar for establishing significant cyber risk.”</p>
        <p>However, this striking result supports a practice of testing all models in a release in the future. Maybe, as in this instance, a smaller, distilled model happens to be very good at a particular task over larger models.</p>
        <p><strong>Problem 3: Internally deployed models should be evaluated.</strong> <a href="https://www.apolloresearch.ai/research/ai-behind-closed-doors-a-primer-on-the-governance-of-internal-deployment/">We know</a> that AI labs have more powerful models that they use internally before they are released publicly (some may never be released). We don’t know if these models are evaluated; but if not, they absolutely should be.</p>
        <p>For instance, <a href="https://thezvi.substack.com/p/gpt-5s-are-alive-basic-facts-benchmarks?open=false#%C2%A7is-that-the-best-you-can-do">statements</a> from Sam Altman and from other AI policy experts support the idea that the GPT-5 models are not the most capable OpenAI has trained, just the most capable that it’s publicly releasing at this time. Mowshowitz <a href="https://thezvi.substack.com/p/gpt-5s-are-alive-basic-facts-benchmarks?open=false#%C2%A7is-that-the-best-you-can-do">pointed out</a> that, “[i]f indeed there are superior internal models, those are the ones currently creating the most danger, and most in need of proper frontier testing.”</p>
        <p>While internal models may not need the same degree of evaluating as public releases since the number of users is drastically decreased, these models should be evaluated, and probably by third parties. It remains critical to evaluate the most significant CBRN, cybersecurity, and autonomy risks in case the <a href="https://www.rand.org/pubs/research_reports/RRA2849-1.html">model weights are stolen</a>, or the model <a href="https://arxiv.org/abs/2412.04984">exfiltrates the weights on its own</a> while being used internally.</p>
      `,
    },
    {
      id: "analysis-7",
      ...
      content: `
        ...
        <p>With its recent gpt-oss open-weight models, OpenAI <a href="https://thezvi.substack.com/p/openais-gpt-oss-is-already-old-news?open=false#%C2%A7good-habits">seemed to take</a> safety evals “as responsibly as one could in practice expect.” Importantly, evals <a href="https://cdn.openai.com/pdf/419b6906-9da6-406c-a19d-1bb078ac7637/oai_gpt-oss_model_card.pdf#page=18">were performed</a> on an adversarially fine-tuned version of the largest model with maximized biological and cyber capabilities, capturing a worst-case scenario picture of the risks. However, third-party involvement seemed to be a step down from OpenAI’s flagship closed models, as <a href="https://cdn.openai.com/pdf/419b6906-9da6-406c-a19d-1bb078ac7637/oai_gpt-oss_model_card.pdf#page=23">SecureBio</a> was the only external organization that actually performed an eval, per the system card. <a href="https://cdn.openai.com/pdf/419b6906-9da6-406c-a19d-1bb078ac7637/oai_gpt-oss_model_card.pdf#page=18">METR and a domain expert</a>t, along with SecureBio, “independently review[ed] and validate[d] [OpenAI’s] malicious fine-tuning methodology,” but did not appear to actually evaluate the model.</p>
