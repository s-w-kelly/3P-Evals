...
export const siteConfig = {
 ...
 <br>
 <p><strong>Motivations/Why this matters:</strong> I believe third-party evals, probably at least in part by private organizations, may be an essential component of a workable frontier AI governance framework. AI labs can’t be trusted to govern themselves (as is currently occurring), and government agencies are unlikely to have the technical capacity or resources to evaluate every frontier model across every risk area on their own, so private evaluators will likely need to play a significant role. As this third-party evaluation ecosystem is developing, I wanted to understand which labs are seeking external evaluation, what risk domains are being tested, and which organizations are emerging as evaluators. I hope this can serve as a resource for thinking about how to incorporate third-party oversight into frontier AI governance.</p>
`,
};
  ...
  analysisInsights: [
    ...
    },
    {
      ...
      content: `
        ...
        <p>This track record establishes that third-party evals can be effective in identifying and mitigating model risks in key areas, supporting the inclusion of external evaluations as a key component of a frontier AI governance regime. Providing sufficient model access (to CoT, etc.) and information is also critical to allow the evaluators to do their job.</p>
        `,
    },
    {
      id: "analysis-4",
    ...
    },
    {
      ...
      content: `
        <p>Labs often skip evals for incremental model updates. This is reasonable in theory, but the labs themselves determine what counts as “incremental,” and sometimes that determination is questionable.</p>
